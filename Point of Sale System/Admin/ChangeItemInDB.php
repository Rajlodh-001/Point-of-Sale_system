...
if ($_SERVER["REQUEST_METHOD"] == "POST" &&
    ...
    $phpVariable10 = $_POST["variable10"];
    ...
    try {
        ...
        // $stmt = $conn->prepare("UPDATE menuitems SET (menuItemName, menuItemPrice, menuItemImage, menuItemCategory) VALUES (:variable1, :variable2, :variable3, :variable4) WHERE menuItemId = :variable10");

        $stmt = $conn->prepare("UPDATE menuitems SET menuItemName = :variable1, menuItemPrice = :variable2, menuItemImage = :variable3, menuItemCategory = :variable4 WHERE menuItemId = :variable10");



        // Bind parameters
        $stmt->bindParam(':variable10', $phpVariable10, PDO::PARAM_INT);
