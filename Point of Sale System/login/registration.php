...
<body>
    <div class="container">
     ...
     <h2 class="pb-5 text-center font-monospace fs-">Registration</h2>
        <?php
        ...
        <div><p class="pt-2">Admin Registration  <a href="http://localhost/POS/login/Adminregistration.php">Register Here.</a></p></div>
      </div>
    </div>
</body>
</html>